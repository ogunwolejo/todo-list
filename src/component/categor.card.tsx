...
const CategoryCard:FC<{title:string; data:number; createdAt:string; icon:ReactNode; description?:string }> = ({title, data, createdAt, icon, description}) => {
    ...
    return (
        <Fragment>
            <div className={`h-20 md:h-28 w-full border-box drop-shadow-xl border border-transparent bg-white rounded-lg flex flex-row items-center justify-center hover:cursor-pointer`} onClick={openModalHandler}>
